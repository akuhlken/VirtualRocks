...
class main(Tk):
    ...
    def update_recent(self):
        strpickle = str(self.picklepath)
        if "\"" in strpickle:
            strpickle.replace("\"", "/")
        if strpickle in self.recentlist:
            self.recentlist.remove(strpickle)
        if strpickle and str(self.imgdir):
            self.recentlist.append(strpickle)
            print("adding " + strpickle)
